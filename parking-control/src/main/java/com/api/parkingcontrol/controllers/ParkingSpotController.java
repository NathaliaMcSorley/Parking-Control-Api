...
public class ParkingSpotController {
	...
	public ResponseEntity<Object> getOneParkingSpot(
		...
		if (!parkingSpotService.existsByParkingSpotNumber(parkingSpotNumber)) {
			return ResponseEntity.status(HttpStatus.NOT_FOUND).body("This parking spot does not exist!");
		}
		return ResponseEntity.status(HttpStatus.OK).body(parkingSpotService.findByParkingSpotNumber(parkingSpotNumber));
	}
